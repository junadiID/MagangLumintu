...
<body style="background-image: url('assets/img/background.jpg')">
    ...
    <div class="container px-8 max-w-md mx-auto sm:max-w-xl md:max-w-5xl lg:flex lg:max-w-full lg:p-0">
        <div class="lg:p-16 lg:mt-8 lg:flex-1">
            ...
            <form method="post">
                ...
                <div class="mt-5">
                    ...
                    <div class="flex">
                        <button class="w-full px-6 py-2 mt-4 text-white bg-[#b6833b] rounded-full hover:bg-[#c5985f]" name="submit">Masuk</button>
                    </div>
        ...
        <div class="hidden lg:flex lg:w-1/2 my-auto p-36">
            <img src="assets/img/login.png" class="animate-bounce lg:mt-10 lg:h-full lg:w-80 lg:object-scale-down lg:object-top">
        </div>
    </div>
