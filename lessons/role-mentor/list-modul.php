...
if (!isset($_SESSION['user_data'])) { //if login in session is not set
    header("Location: https://lumintulearning.tech/account/login.php");
    die;
}
...
$urlf = 'https://lumintulearning.tech/lessons/api/modul/read_moduls_tree_batch.php?batch_id=' . $user_batch_id; //filter pake batch_id
...
$ambil = 'https://lumintulearning.tech/lessons/api/modul/read_modul_rows.php';
...
// untuk get username 
$ch3 = curl_init();
$url2 = 'https://lumintulearning.tech/account/api/users.php';
            ...
            <div class="flex flex-col gap-y-6">
                ...
                <div>
                    <ul class="flex flex-col gap-y-1">
                        <li>
                            <a href="https://lumintulearning.tech/account/dashboard.php" class="flex items-center gap-x-4 h-[50px] rounded-xl px-4 hover:bg-cream text-dark-green hover:text-white">
    ...
    <script type="text/javascript">
        ...
        function deleteModul(id) {
            ...
            if (ok) {
                ...
                $.ajax({
                    url: "https://lumintulearning.tech/lessons/api/modul/delete.php",
                    type: "post",
                    data: {
                        id: id
                    },
...
// script ajax untuk upload modul 
        function postModul() {
            ...
            // console.log(batchId);
            $.ajax({
                url: "https://lumintulearning.tech/lessons/api/modul/create.php",
                type: "post",
                data: {
        ...
        function openModal(id) {
            ...
            // console.log(id);
            $.ajax({
                url: "https://lumintulearning.tech/lessons/api/modul/read_single_modul.php?id=" + id,
                method: "get",
        ...
        function updateModul(id) {
            ...
            $.ajax({
                url: "https://lumintulearning.tech/lessons/api/modul/update.php?id=" + id,
                type: "post",
                data: arr,
                success: function(res) {
                    if (!res.error) {
