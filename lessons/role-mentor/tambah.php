...
//
$ch = curl_init();
$url = 'https://lumintulearning.tech/lessons/api/modul/read_single_modul_tree.php?id=' . $_GET['modulId'];
...
$ch1 = curl_init();
$url1 = 'https://lumintulearning.tech/lessons/api/modul/read_single_modul.php?id=' . $_GET['modulId'];
...
$url3 = 'https://lumintulearning.tech/account/api/batch.php';
...
$ch5 = curl_init();
$url3 = 'https://lumintulearning.tech/lessons/api/modul_competence/read_by_modul.php?id=' . $_GET['modulId'];
...
<body>
    ...
    <script>
        ...
        async function postSingleFile(modulId, fileData) {
            ...
            return $.ajax({
                url: "https://lumintulearning.tech/lessons/api/modul_file/upload.php",
                type: "post",
                contentType: false,
                processData: false,
                cache: false,
