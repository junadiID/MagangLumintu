...
// $_SESSION['user_data']->user->role_id
$role = 2;
switch ($role) {
    case 1:
        //admin
...
$ch1 = curl_init();
$url1 = 'https://https://lumintulearning.tech/lessons/api/modul/read_single_modul.php?id='. $_GET['modulId'];
