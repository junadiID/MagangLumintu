...
$ch = curl_init();
$url = 'https://lumintulearning.tech/lessons/api/modul/read_single_modul.php?id=' . $_GET['modulId'];
...
$curl = curl_init();
$datal = 'https://lumintulearning.tech/lessons/api/modul_file/read_by_modul.php?id=' . $_GET['modulId'];
    ...
    <script>
        ...
        function deleteFile(id) {
            ...
            if (ok) {
                console.log("deleting file..");
                $.ajax({
                    url: "https://lumintulearning.tech/lessons/api/modul_file/delete_single.php",
                    type: "post",
                    data: {
                        id: id
                    },
        ...
        function updateModul() {
            ...
            $.ajax({
                url: "https://lumintulearning.tech/lessons/api/modul/update.php",
                type: "post",
                data: {
                    id: modulId,
