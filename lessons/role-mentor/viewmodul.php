...
$url3 = 'https://lumintulearning.tech/account/api/batch.php?batch_id=' . $_GET['batchId'];
 ...
 <div id="keluar-modal" tabindex="-1"
        ...
        <script>
            ...
            function openModal(id) {
                console.log(id);
                $.ajax({
                    url: "https://lumintulearning.tech/lessons/api/modul_file/read_by_modul.php?id=" + id,
                    method: "get",
